...
@section('content')
    <div class="container">
        <a href="{{route('article.create')}}" class="btn btn-success my-3">Создать новость</a>
                    ...
                    <div class="col-md-9 d-flex py-3 pr-3">
                        ...
                        <div class="container col-md-3">
                            <div class="row no-gutters">
                                ...
                                <a href="{{route('article.show', $article->id)}}" class="btn btn-success col-12" target="_blank">Посмотреть</a>
                            </div>
                        </div>
                    </div>
                </div>
